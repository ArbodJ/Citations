// Creation du tableau multidimentionnel
let citations = [
...
// Creation et fonctionnement de l'evenement du boutton
btn.addEventListener('click', () => {
  const randomNumber = Math.floor(Math.random() * citations.length);
  text.textContent = citations[randomNumber][0] ;
